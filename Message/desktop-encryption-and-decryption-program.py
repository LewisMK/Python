...
def main_screen():
    ...
    image_icon = PhotoImage(file= r"C:\Users\Elwiz\Desktop\PYTHON\Python\Message\encryption.png")
    screen.iconphoto(False, image_icon)
    screen.title("The Crypt")
    
    def reset():
        code.set("")
        text1.delete(1.0, END)
    
    Label(text = "Enter text to encrypt and decrypt: ", fg="black", font=("arial", 13)).place(x=10, y=10)
